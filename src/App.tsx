...
export default function Home() {
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-between font-body game-background">
      ...
      <div className="w-full h-screen min-h-0 relative isolate overflow-hidden flex flex-col">
        <h1 className="shrink-0 px-4 py-2 text-3xl sm:text-4xl font-bold font-display leading-none game-title">
          AI Town
        </h1>
        ...
        <footer className="shrink-0 w-full flex items-center gap-2 px-3 py-2 flex-wrap pointer-events-none">
